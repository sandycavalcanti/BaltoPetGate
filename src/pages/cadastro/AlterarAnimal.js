import { TouchableOpacity, Text, View, TextInput, StyleSheet, ScrollView, Image, ToastAndroid } from "react-native";
            ...
            <ContainerCadastro titulo='Cadastro animal'>
                ...
                <GroupBox titulo='Informações'>
                    ...
                    <View style={styles.containerCampos}>
                        <Campo placeholder="Idade" keyboardType="numeric" set={setIdade} defaultValue={dadosanimal.TB_ANIMAL_IDADE} />
                    ...
                    <View style={styles.ContainerDublo}>
                        ...
                        <View style={styles.campo}>
                            <Campo placeholder="Peso" keyboardType="numeric" set={setPeso} defaultValue={dadosanimal.TB_ANIMAL_PESO} />
