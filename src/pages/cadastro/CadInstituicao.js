...
const CadInstituicao = ({ navigation: { navigate } }) => {
  ...
  return (
    ...
    <ScrollView style={{ width: '100%', height: '100%', }}>
      <View style={styles.container}>
        <Text style={styles.titulo}>Cadastre sua instituição!</Text>
        ...
        <View style={styles.containercampo}>
          <Text style={styles.titulocampo}>Insira o nome da sua instituição:*</Text>
          <TextInput onChangeText={text => setInstituicao(text)} placeholderTextColor={'grey'} placeholder={"Nome da instituição"} style={styles.textinput} />
        </View>
        <View style={styles.containercampo}>
          <Text style={styles.titulocampo}>Insira o nome do responsável pela instituição:*</Text>
        ...
        <View style={styles.containercampo}>
          <Text style={styles.titulocampo}>Insira a localização da sua instituição (Opcional):</Text>
