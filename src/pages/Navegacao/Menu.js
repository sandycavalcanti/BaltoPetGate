    ...
    const CustomChatButton = () => {
        return (
            <TouchableOpacity onPress={() => navigate('HistChat')} style={styles.chatButton}>
                <Ionicons name="chatbubble-ellipses-outline" size={32} color={'#ededed'} />
            </TouchableOpacity>
        )
    }
        ...
        <SafeAreaView style={{ flex: 1 }}>
            <Tab.Navigator screenOptions={{ tabBarStyle: styles.container, tabBarHideOnKeyboard: true, header: () => <HeaderExplorar />, tabBarShowLabel: false, title: '' }} >
                <Tab.Screen
                    ...
                    component={Home}
                    options={{
                        tabBarIcon: props => <Octicons name="home" size={30} color={props.focused ? '#fff' : '#ededed'} />,
                    }} />
                <Tab.Screen
                    name="Explorar"
                    component={Explorar}
                    options={{
                        tabBarIcon: props => <Ionicons name="search-sharp" size={35} color={props.focused ? '#fff' : '#ededed'} />,
                    }} />
                <Tab.Screen
                    name="HistChat"
                    component={HistChat}
                ...
                <Tab.Screen
                    ...
                    component={Mapa}
                    options={{
                        tabBarIcon: props => <Feather name="map-pin" size={30} color={props.focused ? '#fff' : '#ededed'} />,
                    }} />
                <Tab.Screen
                    name="Animal"
                    component={Animal}
